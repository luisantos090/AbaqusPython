...
path = r"C:\Users\pinhosl3\Desktop\GA_vide"
os.chdir(path)
...
variables = []
variables.append([200.0, length/2.0 - 200.0, 7])
variables.append([200.0, width/2.0 - 200.0, 6])

variables.append([length/2.0 + 200.0, length - 200.0, 7])
variables.append([200.0, width/2.0 - 200.0, 6])

variables.append([200.0, length/2.0 - 200.0, 7])
variables.append([width/2.0 + 200.0, width - 200.0, 6])
